...
//TODO make it so that things happeing on every iteration arent messed up by iteration time increasing
                ...
                var drawSprite = function() {
                    if (this.x < viewMaxX && this.x > viewMinX - this.width && this.y < viewMaxY && this.y > viewMinY - this.height) {
                        ctx.beginPath();
                    		...
                    		ctx.drawImage(drawing, getCanvasX(this.x) - (this.width/10), getCanvasY(this.y)-(this.height/10), this.width, this.height);
