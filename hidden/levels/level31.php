...
*/
                ...
                var instances = [rectangles, spitters, players, circleShots, cursors, views];
								//*******METHODS*********
//death methods
...
//problem with wanting the order to be track then bounce or bounce then track
										["isAlive", "fire", "draw", "track", "bounce", "update"/*set angle to dxdy*/ /*"update"*/  /*"warp"*/].map(invokeOnInstances);
										viewUpdate();
                    move();
                }
