...
//WORK
//two tracks, one for cursor and the other for view supposedly
//the finalI//
										["handleSpace", "update", "isAlive", "fire", "track", "eventDirection", "track", "eventDirection", "draw",  "bounce"/*set angle to dxdy*/ /*"update"*/  /*,"warp"*/].map(invokeOnInstances);
