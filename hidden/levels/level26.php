    ...
    <p id="keycode">
        <p>
          ...
          var message = document.getElementById("keycode");
                ...
                var rectangle2 = new Rectangle(100, 500, 30, 300, "green");
                var rectangle3 = new Rectangle(300, 50, 30, 30, "orange");
                var rectangle4 = new Rectangle(50, 200, 30, 30, "yellow");
                var rectangle5 = new Rectangle(50, 0, 30, 30, "yellow");
                var rectangle6 = new Rectangle(100, 0, 30, 30, "yellow");
                var rectangle7 = new Rectangle(75, 25, 30, 30, "yellow", 3000000);
                var rectangles = [rectangle, rectangle2, rectangle3, rectangle4, rectangle5, rectangle6, rectangle7];
                //spitters
                var spitter = new Spitter(200, 200, 40, 40);
...
//update methods
                ...
                function Spitter(x, y, width, height, health, speed, color) {
                    ...
                    this.reload = 0;
								...
								//Spitter.prototype.fire = fireMouseDown(PlayerCircleShot, playerCircleShots);
                ...
                PlayerCircleShot.prototype.draw = drawCircle;
								PlayerCircleShot.prototype.warp = degreeWarp(9);
