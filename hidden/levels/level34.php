...
//the or Does not work
                ...
                this.y = canvas.height/2;
								...
								//View.prototype.track = function(){trackStopNearObject(this, this.trackTarget, 5);};
...
//make this section just dx = getDxToCursor(this);
                ...
                function Cursor() {
                    ...
                    this.src = "/images/crossheirs.png"
								...
								Cursor.prototype.eventDirection = handleWASD(player);
...
//problem with wanting the order to be track then bounce or bounce then track
									//	viewUpdate();
										["eventDirection", "update", "isAlive", "fire", "draw", "track", "bounce"/*set angle to dxdy*/ /*"update"*/  /*"warp"*/].map(invokeOnInstances);
